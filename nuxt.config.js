  ...
  */
  head: {
    ...
    meta: [
      ...
      { name: 'keywords', content: 'harapeco, ハラペコマップ, ハラペコMap, harapeco map'},
      { hid: 'description', name: 'description', content: process.env.npm_package_description || 'おすすめの飲食店情報をシェアしよう！' },
